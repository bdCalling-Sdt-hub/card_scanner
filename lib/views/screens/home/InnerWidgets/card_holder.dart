                    ...
                    ? Column(
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                CustomText(
                                  text:
                                      "(${storageController.contacts.length})",
                                ),
                                const Spacer(),
                                ...
                                InkWell(
                                  onTap: () {
                                    PrefsHelper.getGroupedList().then((value) {
                                      storageController.groupedContactsList =
                                          value;
                                    });
                                  ...
                                  child: Row(
                                    children: [
                                      SvgPicture.asset(AppIcons.groupIcon),
                                      SizedBox(width: 4.w),
                                      CustomText(
                                ...
                                InkWell(
                                  ...
                                  child: Row(
                                    children: [
                                      SizedBox(width: 8.w),
                                      SvgPicture.asset(AppIcons.manageIcon),
                                      SizedBox(width: 4.w),
                                      CustomText(
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              height: (150 * storageController.contacts.length)
                                  .toDouble(),
                                    ...
                                    builder: (controller) {
                                      return Padding(
                                        ...
                                        child: GestureDetector(
                                          onTap: () {
                                            Get.toNamed(
                                                AppRoutes.contactDetailsScreen,
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  InkWell(
                                                                    onTap: () {
                                                                      Share.share(
                                                                          "${storageController.contacts[index].name}, ${storageController.contacts[index].designation}, ${storageController.contacts[index].companyName}, ${storageController.contacts[index].mobilePhone}, ${storageController.contacts[index].email}, ${storageController.contacts[index].address}");
                          ...
                          Column(
                            children: [
                              SizedBox(
                                  height: 74.h,
                                  width: 74.w,
                                  child: Image.asset(AppImages.cardLogo)),
                              SizedBox(
                                height: 16.h,
                              ),
                              CustomText(
