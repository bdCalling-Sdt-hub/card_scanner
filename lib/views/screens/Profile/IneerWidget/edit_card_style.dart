...
import '../../../../Helpers/screen_shot_helper.dart';
                            ...
                            image: PrefsHelper.isLogoShow
                                ? DecorationImage(
                                    ...
                                    colorFilter: PrefsHelper.colorIndex == 3 ||
                                        ...
                                        : null,
                                    opacity: PrefsHelper.colorIndex == 2 ||
                                            PrefsHelper.colorIndex == 5
                                        ? 0.15
                                        : 0.4)
                                : null,
                          ),
                        ...
                        children: [
                          ...
                          CachedNetworkImage(
                            ...
                            imageBuilder: (context, imageProvider) => Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: PrefsHelper.isProfilePhotoShow
                                    ? DecorationImage(
                                        fit: BoxFit.fill,
                                        image: imageProvider,
                                      )
                          ...
                          Padding(
                            padding: EdgeInsets.only(
                                left: 32.w, top: 16.h, bottom: 16.h),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                SizedBox(
                                ...
                                customInfoRow(
                                    infoIcon: Icons.phone_iphone_outlined,
                                    infoText:
                  ...
                  itemBuilder: (context, index) {
                    return Obx(() => GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: profileController.selectedColorIndex.value ==
                                    index
                                ? Center(
                                    child: Container(
                                      height: 20,
