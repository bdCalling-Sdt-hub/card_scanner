...
class Locales extends Translations{
  ...
  Map<String, Map<String, String>> get keys =>{
    ...
    'zh_CN' : {
      ...
      "Pioneering success through seamless scanning solutions for shoppers." : "通过无缝扫描解决方案为购物者开创成功。",
      "Simplified E-Commerce via Card Scanner" : "通过卡扫描器简化电子商务",
      "Simplify e-commerce with a card scanner for effortless transactions and convenience." : "使用卡扫描器简化电子商务，实现轻松交易和便利。",
      "Scan and Shop with Ease" : "轻松扫描和购物",
      "Scan products effortlessly and shop conveniently with our user-friendly system." : "使用我们用户友好的系统轻松扫描产品并方便购物。",
      "Skip" : "跳过",
      "Sign In" : "登录",
      "Sign Up" : "注册",
      "Sign Up Now" : "立即注册",
      ...
      "Please enter your email address to reset your password." : "请输入您的电子邮件地址以重置密码。",
      "OR" : "或者",
      "Contact Number" : "联系电话",
      "Enter Mobile Number" : "输入手机号码",
      "Get OTP" : "获取OTP",
      "Enter Your Mobile Number" : "输入您的手机号码",
      "You will receive an OTP on the registered mobile number you have entered" : "您将收到您输入的注册手机号码上的OTP",
      "By continuing in you agree to our Terms and Conditions & Privacy Policy" : "继续即表示您同意我们的条款和条件及隐私政策",
      "Next" : "下一步",
      ...
      "Password must be 6 characters long & contain both \nalphabets and numerics" : "密码必须为6个字符长，并包含字母和数字",
      "Password does not match" : "密码不匹配",
      "Password reset successfully" : "密码重置成功",
      "Name is required" : "需要姓名",
      "Name" : "姓名",
      "Selected items" : "选定的项目",
      "Share with anyone, even if they don’t have the app." : "与任何人分享，即使他们没有应用程序。",
      ...
      "Cards" : "卡片",
      "No Cards" : "没有卡片",
      "You can use the business card recognition function to upload business cards and efficiently manage your contacts" : "您可以使用名片识别功能上传名片并高效管理您的联系人",
      "Smart Sync" : "智能同步",
      "Mobile backup" : "手机备份",
      ...
      "Backup your contact information in google drive for safekeeping" : "将您的联系信息备份到Google Drive以确保安全",
      "Upload" : "上传",
      "To get access another google account press on logout," : "要访问其他Google帐户，请按注销，",
      "Logout" : "注销",
      "Google drive backup" : "Google Drive备份",
      "Protect your data backup in google drive securely." : "在Google Drive中安全保护您的数据备份。",
      ...
      "No contact found. Please try again later for updated information or check back soon." : "未找到联系人。请稍后再试以获取更新的信息或稍后再回来查看。",
      "Add Contact" : "添加联系人",
      "Gallery" : "相册",
      "Camera" : "相机",
      "Google Sign In does not support web view, So don't try 'Continue with Google'" : "Google登录不支持Web视图，因此不要尝试“继续使用Google”",
      "LinkedIn" : "LinkedIn",
      "Google" : "Google",
      "Done" : "完成",
      ...
      "Effortlessly scan, save, and share name cards with our intuitive mobile app." : "使用我们的直观移动应用轻松扫描、保存和分享名片。",
      "Seamlessly digitize contacts with precision, simplicity, and efficiency." : "精准、简单、高效地无缝数字化联系人。",
      "Efficiently capture, organize name cards with our fast, intuitive scanning feature." : "使用我们快速、直观的扫描功能高效地捕捉和整理名片。",
      ...
      "I need only from the text name, designation, company name, email, phone number and address with no key, value pair just only values with '/' separated, if not get the desired value then give blank text" : "我只需要文本中的姓名、职位、公司名称、电子邮件、电话号码和地址，不要键值对，只需用'/'分隔的值，如果没有获得所需的值，则给出空白文本",
      "Google & Apple SignIn doesn't support in web view, So don't try" : "Google和Apple登录不支持Web视图，因此不要尝试",
