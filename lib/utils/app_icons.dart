...
class AppIcons{
  ...
  static String fbIcon = "$iconsBasePath/fbIcon.svg";
  static String googleIcon = "$iconsBasePath/googleIcon.svg";
  static String linkedinIcon = "$iconsBasePath/linkedinIcon.svg";
