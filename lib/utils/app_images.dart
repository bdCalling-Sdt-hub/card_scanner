...
class AppImages{
  ...
  static String splashImg = "$imagesBasePath/splashImage.png";
  static String logo = "$imagesBasePath/logo.svg";
  static String onboardImg1 = "$imagesBasePath/onboardImg1.svg";
  static String onboardImg2 = "$imagesBasePath/onboardImg2.svg";
  static String onboardImg3 = "$imagesBasePath/onboardImg3.svg";
